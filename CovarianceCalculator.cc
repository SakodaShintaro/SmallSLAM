...
double CovarianceCalculator::calIcpCovariance(const Pose2D& pose, std::vector<const LPoint2D*>& curLps,
...
void CovarianceCalculator::calMotionCovariance(double th, double dx, double dy, double dth, double dt,
                                               Eigen::Matrix3d& cov, bool accum) {
  setAlpha(1, 5);
...
void CovarianceCalculator::calUk(double vt, double wt, Eigen::Matrix2d& Uk) { Uk << a1 * vt * vt, 0, 0, a2 * wt * wt; }
...
void CovarianceCalculator::accumulateCovariance(const Pose2D& curPose, const Pose2D& prevPose,
                                                const Eigen::Matrix3d& prevCov, const Eigen::Matrix3d& mcov,
...
void CovarianceCalculator::rotateCovariance(const Pose2D& pose, const Eigen::Matrix3d& cov, Eigen::Matrix3d& icov,
                                            bool reverse) {
