...
double PoseOptimizerSL::search(double ev0, Pose2D &pose, Pose2D &dp) {
  ...
  pair<double, double> result =
      boost::math::tools::brent_find_minima([this, &pose, &dp](double tt) { return (objFunc(tt, pose, dp)); }, -2.0,
                                            2.0, bits, maxIter);  // 探索範囲(-2.0,2.0)
